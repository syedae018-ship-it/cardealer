    ...
    <section className="relative overflow-hidden bg-white dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-0 items-center min-h-[560px] lg:min-h-[620px] py-8 lg:py-0">
          ...
          {/* Right Column: Desktop Split Overlay / Mobile Clean Stack */}
          <div className="lg:col-span-6 xl:col-span-6 relative w-full flex flex-col items-center justify-center">
            
            {/* Desktop: Full height angled car photo with floating card overlay */}
            <div className="hidden lg:flex relative w-full h-[580px] items-end justify-end">
              <div className="absolute inset-0 w-full h-full overflow-hidden [clip-path:polygon(8%_0,_100%_0,_100%_100%,_0%_100%)]">
                <Image
              ...
              <div className="relative z-20 w-full max-w-lg bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md rounded-3xl p-6 shadow-2xl border border-neutral-200/80 dark:border-neutral-800 space-y-3 mb-6 mr-4">
                ...
                <div className="space-y-1">
                  <h2 className="text-lg font-extrabold text-neutral-950 dark:text-white tracking-tight">
            ...
            {/* Mobile / Tablet View: Fully visible car image + Clean stacked commitment card */}
            <div className="lg:hidden w-full space-y-4">
              
              {/* Full Car Photo Container */}
              <div className="relative w-full aspect-[16/10] sm:aspect-[16/9] rounded-3xl overflow-hidden shadow-lg border border-neutral-200 dark:border-neutral-800">
                <Image
                  src="/images/hero-car.jpg"
                  alt="Verified Used Car Bangalore - Syed Sabeer Riyaz"
                  fill
              ...
              {/* Stacked Commitment Card */}
              <div className="bg-white dark:bg-neutral-900 rounded-3xl p-5 shadow-sm border border-neutral-200 dark:border-neutral-800 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center gap-1.5 text-[11px] font-black text-neutral-800 dark:text-neutral-200 uppercase tracking-wider">
                    <User className="w-3.5 h-3.5 text-brand-orange" />
                    <span>DIRECT FROM SYED SABEER</span>
